                                                                        ...
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                ...
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-1.jpg" title="Compete Track Tote" alt="Compete Track Tote">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-9.jpg" title="Wayfarer Messenger Bag" alt="Wayfarer Messenger Bag">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-2.jpg" title="Fusion Backpack" alt="Fusion Backpack">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                ...
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-10.jpg" title="Strive Shoulder Pack" alt="Strive Shoulder Pack">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-3.jpg" title="Rival Field Messenger 6" alt="Rival Field Messenger 6">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-11.jpg" title="Rival Field Messenger" alt="Rival Field Messenger">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-4.jpg" title="Rival Field Messenger" alt="Rival Field Messenger">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-12.jpg" title="Crown Summit Backpack" alt="Crown Summit Backpack">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner d-flex align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 me-md-4 me-xl-5">
                                                                                <div class="label-product label-new">New</div>
                                                                                <a href="single-product.html">
                                                                                    <img src="../../gghv_cosmetic/public/assets/images/products/new/product-5.jpg" title="Crown Summit Backpack" alt="Crown Summit Backpack">
                                                                                </a>
                                                                                <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                    ...
                                    <div class="cat-accordion">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingThree">
                                                <h5 class="mb-0">
                                                    <button type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Accessories</button>
                                                </h5>
                                            </div>
