                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-5 col-lg-6">
                            <div class="overview-img text-center">
                                <a href="#">
                                    <img src="../../gghv_cosmetic/public/assets/images/about/about.jpg" alt="About Us">
                                </a>
                            </div>
                        </div>
                    </div> <!-- end of row -->
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="clients element-carousel" data-visible-slide="5" data-visible-xl-slide="5" data-visible-lg-slide="5" data-visible-md-slide="4" data-visible-sm-slide="3" data-visible-xs-slide="2" data-loop="true" data-autoplay-delay="3000" data-space-between="0" data-effect="slide">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="item-brand swiper-slide">
                                        <img src="../../gghv_cosmetic/public/assets/images/brand/client-logo-5.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img src="../../gghv_cosmetic/public/assets/images/brand/client-logo-6.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img src="../../gghv_cosmetic/public/assets/images/brand/client-logo-7.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img src="../../gghv_cosmetic/public/assets/images/brand/client-logo-8.jpg" alt="Client Logo">
                                    </div>
                                </div>
